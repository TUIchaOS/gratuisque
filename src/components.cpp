...
void Button::SetEnabled(bool enabled) { /* TODO: Implement */ }
bool Button::IsEnabled() const { return true; }
void Button::SetFocus() { /* TODO: Implement */ }
bool Button::IsFocused() const { return false; }
...
void Window::Open() { std::cout << "Window shown: " << _title << std::endl; }
...
// Slider
void Slider::ChangeValue(int32_t value)
{
